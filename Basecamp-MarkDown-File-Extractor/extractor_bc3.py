...
def sanitize_filename(name):
    """
    Sanitize filename by removing invalid characters, stripping separators,
    and handling path traversal attempts.
    """
    # Remove separators and other invalid characters
    name = re.sub(r'[\\/*?:"<>|]', "", name)
