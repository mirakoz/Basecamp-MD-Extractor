...
def clean_html_bc3(html_content):
    ...
    # Remove Basecamp 3 UI elements and sensitive/unwanted tags
    # Explicitly removing script, style, meta, link, and form tags for security
    selectors_to_remove = [
        ".action-sheet", ".button", ".btn", ".avatar", "form",
        ".nav", ".menu", ".tooltip", ".header__menu",
        ".record-tools", ".push-button", ".chat__tools", ".admin",
