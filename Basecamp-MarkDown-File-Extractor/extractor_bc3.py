...
def sanitize_filename(name):
    ...
    Removes invalid characters and all dots to prevent path traversal
    and hidden files. Returns 'unnamed' if the result is empty.
    """
    # Remove invalid characters and all dots
