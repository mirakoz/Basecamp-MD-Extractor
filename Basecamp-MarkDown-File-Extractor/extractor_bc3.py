...
def clean_html_bc3(html_content):
    """
    Cleans Basecamp 3 HTML content by removing interactive elements and potential XSS vectors.
    """
    soup = BeautifulSoup(html_content, 'html.parser')

    # Remove script, style, link, and meta tags to prevent XSS and style injection
